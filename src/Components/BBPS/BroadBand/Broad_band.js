...
const Broad_band = () => {
  ...
  useEffect(() => {
    const apiUrl = `${API_IP_ADDRESS}/bills/getBroadbandPostpaidBillers`;
    fetch(apiUrl, {
      method: "GET",
      headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`${API_IP_ADDRESS}/bills/BroadbandPostpaidfetchBill`, {
        method: "POST",
        headers: {
          Accept: "application/json",
          "Content-Type": "application/json",
      ...
      if (responseData.status === true) {
        ...
        setError(responseData.data.result.payload.errors[0].reason);
      }
    } catch (error) {
  ...
  const handlePaynow = async (e) => {
    ...
    try {
      const response = await fetch(
        `${API_IP_ADDRESS}/bills/broadbandPostpaidbillPay`,
        {
          method: "POST",
          headers: {
            Accept: "application/json",
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', height: '100%', width: "100%" }}>
                    ...
                    <div
                      ...
                      <p style={{ color: 'black', fontWeight: 'bold' }}>
                        <h4>Your  BroadBand  Bill Paid Successfully</h4>
                      </p>
                    </div>
                    ...
                    <div
                      ...
                      <Typography>
                        <div>
                          <p style={{ fontSize: "12px", textAlign: "center" }}>Your  BroadBand Bill Paid Successfully</p>
