...
const Challan = () => {
  ...
  useEffect(() => {
    fetch(`${API_IP_ADDRESS}/bills/getChallanBillerDetails`, {
      method: "GET",
      headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      const response = await fetch(`${API_IP_ADDRESS}/bills/challanBillFetch`, {
        method: "POST",
        headers: {
          Accept: "application/json",
          "Content-Type": "application/json",
  ...
  const handlePaynow = async (e) => {
    ...
    try {
      const response = await fetch(
        `${API_IP_ADDRESS}/bills/challanBillPaymentRequest`,
        {
          method: "POST",
          headers: {
            Accept: "application/json",
