...
const Club = () => {
  ...
  useEffect(() => {
    fetch(`${API_IP_ADDRESS}/bills/getClubBillerDetails`, {
      method: "GET",
      headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true)
    try {
      const response = await fetch(`${API_IP_ADDRESS}/bills/clubBillFetch`, {
        method: "POST",
        headers: {
          Accept: "application/json",
          "Content-Type": "application/json",
  ...
  const handlePaynow = async (e) => {
    ...
    try {
      const response = await fetch(
        `${API_IP_ADDRESS}/bills/clubBillPaymentRequest`,
        {
          method: "POST",
          headers: {
            Accept: "application/json",
            ...
            <div>
              ...
              >
                ...
                <Autocomplete
                  ...
                  renderInput={(params) => (
                    <TextField {...params} placeholder="Select Club & Association"
                      sx={{
                        width: "100%",
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', height: '100%', width: "100%" }}>
                    ...
                    <div
                      ...
                      <p style={{ color: 'black', fontWeight: 'bold' }}>
                        <h4>Your  Club  Bill Paid Successfully</h4>
                      </p>
                    </div>
                    ...
                    <div
                      ...
                      <Typography>
                        <div>
                          <p style={{ fontSize: "12px", textAlign: "center" }}>Your  Club Bill Paid Successfully</p>
