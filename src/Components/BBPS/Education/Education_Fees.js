...
const Education_Fees = () => {
  ...
  useEffect(() => {
    fetch(`${API_IP_ADDRESS}/bills/getEducationalFeesBillerDetails`, {
      method: "GET",
      headers: {
  ...
  const handleParams = async(e) => {
    ...
    const handleSubmit = async (e) => {
      ...
      setLoading(true);
      try {
        const response = await fetch(`${API_IP_ADDRESS}/bills/educationalFeesBillFetch`, {
          method: "POST",
          headers: {
            Accept: "application/json",
            "Content-Type": "application/json",
    ...
    const handlePaynow = async (e) => {
      ...
      try {
        const response = await fetch(
          `${API_IP_ADDRESS}/bills/educationalFeesBillPaymentRequest`,
          {
            method: "POST",
            headers: {
              Accept: "application/json",
      ...
      <div style={{ visibility: "visible" }}>
        ...
        {isPopupOpen && (
          <div className="popup1_Insurance">
            ...
            <div>
            <h2 style={{fontSize:"24px",textAlign:"center",color:"#3746c8" }}> Bill Details</h2>
