...
const Electricity_Bills = () => {
  ...
  useEffect(() => {
    fetch(`${API_IP_ADDRESS}/bills/getElectricityBillers`, {
      method: "GET",
      headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      const response = await fetch(`${API_IP_ADDRESS}/bills/electricityfetchBillRequest`, {
        method: "POST",
        headers: {
          Accept: "application/json",
          "Content-Type": "application/json",
  ...
  const handlePaynow = async (e) => {
    ...
    try {
      const response = await fetch(
        `${API_IP_ADDRESS}/bills/electricitybillPaymentRequest`,
        {
          method: "POST",
          headers: {
            Accept: "application/json",
            ...
            <div>
              <form>
                ...
                <Autocomplete
                  ...
                  renderInput={(params) => (
                    <TextField {...params} placeholder="Select Electricity Board"
                      sx={{
                        width: "100%",
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', height: '100%', width: "100%" }}>
                    ...
                    <div
                      ...
                      <p style={{ color: 'black', fontWeight: 'bold' }}>
                        <h4>Your Electricity  Bill Paid Successfully</h4>
                      </p>
                    </div>
                    ...
                    <div
                      ...
                      <Typography>
                        <div>
                          <p style={{ fontSize: "12px", textAlign: "center" }}>Your Electricity Bill Paid Successfully</p>
