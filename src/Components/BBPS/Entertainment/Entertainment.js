...
const Entertainment = () => {
  ...
  useEffect(() => {
    fetch(`${API_IP_ADDRESS}/bills/getEntertainmentBillerDetails`, {
      method: "GET",
      headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        `${API_IP_ADDRESS}/bills/entertainmentBillFetch`,
        {
          method: "POST",
          headers: {
            Accept: "application/json",
  ...
  const handlePaynow = async (e) => {
    ...
    try {
      const response = await fetch(
        `${API_IP_ADDRESS}/bills/entertainmentBillPaymentRequest`,
        {
          method: "POST",
          headers: {
            Accept: "application/json",
        ...
        <Container component="main" maxWidth="xm"  >
          ...
          {loading && (
            ...
            <div style={{ visibility: "visible" }}>
              {/* Popup 1 */}
              {isPopupOpen && (
                <div className="popup1_Entertainment">
                  <button
                    style={{
                      position: "absolute",
                      top: "10px",
...
<div style={{fontSize:"24px"}}>
              ...
              {/* Popup 2 */}
              {isPopupOpen1 && (
                <div className="popup_Entertainment">
                  <button
                    style={{
                      position: "absolute",
                      top: "10px",
