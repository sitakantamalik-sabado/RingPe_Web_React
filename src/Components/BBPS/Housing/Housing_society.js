...
const Housing_society = () => {
  ...
  useEffect(() => {
    fetch(`${API_IP_ADDRESS}/bills/getHousingSocietyBillerDetails`, {
      method: "GET",
      headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      const response = await fetch(`${API_IP_ADDRESS}/bills/housingSocietyBillFetch`, {
        method: "POST",
        headers: {
          Accept: "application/json",
          "Content-Type": "application/json",
  ...
  const handlePaynow = async (e) => {
    ...
    try {
      ...
      const paymentResponse = await fetch(
        `${API_IP_ADDRESS}/bills/housingSocietyBillPaymentRequest`,
        {
          method: "POST",
          headers: {
            Accept: "application/json",
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', height: '100%', width: "100%" }}>
                    ...
                    <div
                      ...
                      <p style={{ color: 'black', fontWeight: 'bold' }}>
                        <h4>Your House  Bill Paid Successfully</h4>
                      </p>
                    </div>
                    ...
                    <div
                      ...
                      <Typography>
                        <div>
                        <p style={{fontSize:"12px",textAlign:"center"}}>Your House Bill Paid Successfully</p>
...
export default Housing_society;