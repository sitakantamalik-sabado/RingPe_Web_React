...
const Lpg_Gas = () => {
  ...
  useEffect(() => {
    fetch(`${API_IP_ADDRESS}/bills/getLPGBillerDetails`, {
      method: "GET",
      headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      const response = await fetch(`${API_IP_ADDRESS}/bills/LPGfetchBillRequest`, {
        method: "POST",
        headers: {
          Accept: "application/json",
          "Content-Type": "application/json",
  ...
  const handlePaynow = async (e) => {
    ...
    try {
      const response = await fetch(
        `${API_IP_ADDRESS}/bills/LPGBillPaymentRequest`,
        {
          method: "POST",
          headers: {
            Accept: "application/json",
            ...
            {/* <div style={{ visibility: "visible" }}>
              ...
              {isPopupOpen && (
                <div className="popup1_Lpg_Gas">
                  ...
                  <div>
                    <h3 style={{ fontSize: "24px", textAlign: "center", color: "#3746c8" }}>Bill Details</h3>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', height: '100%', width: "100%" }}>
                    ...
                    <div
                      ...
                      <p style={{ color: 'black', fontWeight: 'bold' }}>
                        <h4>Your LpgGas  Bill Paid Successfully</h4>
                      </p>
                    </div>
                    ...
                    <div
                      ...
                      <Typography>
                        <div>
                          <p style={{ fontSize: "12px", textAlign: "center" }}>Your LpgGas Bill Paid Successfully</p>
