...
const Muncipal_Tax = () => {
  ...
  useEffect(() => {
    fetch(`${API_IP_ADDRESS}/bills/getMunicipalTaxesBillers`, {
      method: "GET",
      headers: {
  ...
  const handleParams = async(e) => {
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        const response = await fetch(`${API_IP_ADDRESS}/bills/municipalTaxesfetchBill`, {
          method: "POST",
          headers: {
            Accept: "application/json",
            "Content-Type": "application/json",
    ...
    const handlePaynow = async (e) => {
      ...
      try {
        const response = await fetch(
          `${API_IP_ADDRESS}/bills/municipalTaxesBillPaymentRequest`,
          {
            method: "POST",
            headers: {
              Accept: "application/json",
...
<Box sx={{ mt: 3 }} >
    ...
    <div>
        ...
        <form>
          <FormControl fullWidth sx={{ m: 1 }} variant="standard">
            ...
            <Autocomplete
                        ...
                        onChange={handleBillerChange}
                        renderInput={(params) => (
                          <TextField {...params} placeholder="Select Corporation"  
                          sx={{
                            width: "100%",
      ...
      <div style={{ visibility: "visible" }}>
        {/* Popup 1 */}
        {isPopupOpen && (
          <div className="popup1_Muncipal_Tax">
            <button
              style={{
                position: "absolute",
                top: "10px",
        ...
        {/* Popup 2 */}
        {isPopupOpen1 && (
          <div className="popup_Muncipal_Tax">
            <button
              style={{
                position: "absolute",
                top: "10px",
